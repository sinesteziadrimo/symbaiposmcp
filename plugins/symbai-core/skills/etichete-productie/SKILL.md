...
description: Etichete de producție pentru semipreparate, produse și containere (tavă/navetă/bax/palet) — design cu cod de bare/QR și câmpuri automate (lot, dată, valabilitate, alergeni), legare de rețetă/container/magazie/stație, print pe Zebra/termică sau PDF, reguli de rutare. La „fă o etichetă pentru…", „printează etichetele lotului", „de ce nu iese eticheta pe Zebra", „eticheta iese tăiată/mică", „care regulă de etichetă câștigă".
---
