...
description: Configureaza si explica Aplicatia Staff / Symbai Staff din POS web: cardul "In Aplicatie Staff" de pe /menu/platforms, profiluri pentru livratori, agenti teren, CRM, task-uri, preluare marfa, preview telefon cu butoane clickabile si legatura cu rolurile reale din Personal. Foloseste la "configureaza Aplicatie Staff", "Symbai Staff", "expo-sales", "ce vede livratorul", "preview livrator", "ascunde CRM pentru livratori", "agent teren in aplicatia staff", "rol pentru previzualizare", "profil livrator cu vanzari", "aplicatia angajatilor".
---

# Configureaza Aplicatie Staff

Userul vrea sa configureze sau sa inteleaga **Symbai Staff**: aplicatia angajatilor pentru livratori, agenti de teren, CRM/vanzari, task-uri, receptie si operare marfa. Configurarea user-facing se face in POS web pe **/menu/platforms** prin cardul **"In Aplicatie Staff"**.
...
5. Pentru navigare si screenshot citeste `knowledge/condu-chrome.md`.
...
| 2. Operare marfa / bucatarie | `stock_kitchen` | receptie marfa, bucatarie, pregatiri | Task-uri, Preluare marfa, Bucatarie/productie | `tasks_view`, `stock_receive`, `kds_view` |
...
- taburile se aleg din feature-uri: Azi/Acasa, Livrari, Pipeline, Actiuni, Mesaje, Mai mult;
...
9. Daca userul vrea dovada vizuala, fa screenshot la dialog si la preview-ul de telefon.
