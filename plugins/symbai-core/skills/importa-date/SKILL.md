---
name: importa-date
description: Importă datele clientului din Excel/CSV (produse, meniu, stoc, furnizori) — MCP-first cu tool-urile de import de fișier, pagina de import/Chrome pentru fișiere mari sau PDF/poze; răspunzi întrebărilor importului (magazie, tip produs, TVA), completezi datele lipsă și corectezi ce a ieșit strâmb. La „importă-mi datele din vechiul program", „am fișiere Excel cu produsele", „mută-mă de pe alt POS", „am furnizori dublați după import". Meniu de pe site/PDF → adauga-produs-reteta.
---
...
5. **Raport clar**: ce a intrat, ce ai completat din ce sursă, ce ai corectat și DE CE (în limbaj de restaurant), ce a rămas la el în aplicație. La furnizori, spune explicit **câți erau deja în listă** (s-au recunoscut pe codul fiscal, nu s-au dublat) și **ce rânduri au rămas deoparte**, cu motivul — sunt exact cele de completat și reimportat.
...
- **Furnizorii dintr-un fișier se caută înainte de a se crea.** Fiecare rând se caută întâi pe **codul fiscal curățat** (fără RO, fără spații, fără puncte) printre furnizorii existenți. Dacă firma e deja acolo, rândul **nu mai creează nimic** — rămâne furnizorul pe care îl ai, chiar dacă în Excel e scris altfel («MEGA IMAGE» vs «MEGA IMAGE S.R.L.»). Din același motiv, reimportul aceluiași fișier nu dublează nimic. Pentru un cod nou de tot, denumirea se ia de la **ANAF**, așa că în listă poate apărea forma oficială, nu exact textul din fișier — spune-i userului dinainte, e intenționat: așa se leagă documentele viitoare de același partener.
- **Rândurile fără cod fiscal valid rămân deoparte, dar importul MERGE MAI DEPARTE.** Un furnizor nu se creează pe denumire — de acolo vin duplicatele. Fișierul se procesează până la capăt, iar la final primești lista exactă a rândurilor rămase, cu motivul fiecăruia (cod lipsă, cod care nu trece verificarea, e-mail sau nr. de Reg. Com. pus din greșeală în coloana de CUI, sau ANAF n-a răspuns atunci). Le completezi în fișier și reimporți **doar pe acelea** — ce a intrat deja nu se dublează. Cel mai bine, cere coloana de CUI din start, ca userul să nu rămână cu jumătate din furnizori de introdus manual.
- **Furnizorii din afara României nu intră prin fișier.** Importul de furnizori din Excel/CSV lucrează cu **cod fiscal românesc**; un partener cu cod de TVA european (BG…, DE…, HU…) se adaugă separat, din pagina de furnizori sau cu `create_supplier`, unde codul se confirmă la **VIES**. Scoate-i din fișier și fă-i după, ca să nu-ți umple lista de rânduri rămase.
