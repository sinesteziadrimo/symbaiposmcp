...
description: Configurează portalul/aplicația clienților prin MCP — aspect (culori, font), funcții (meniu, comenzi, rezervări, fidelitate, jocuri, chat), texte, tab-uri, meniul public (alergeni, gramaj, filtre), QR de la masă (nivel, date cerute, plată online), jocuri/atracții. La „configurează portalul", „schimbă culorile portalului", „activează rezervările pe portal", „de ce nu apare X în aplicația clienților", „adaugă un joc".
---
