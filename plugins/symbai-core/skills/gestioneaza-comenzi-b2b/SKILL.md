...
5. **Modelul mental al stării**: `draft → confirmed →` (fazele de producție există numai pentru liniile de fabrică) `→ picking → packed → avizata → acceptata → facturata → dispatched → delivered`. Magazinele proprii sunt transfer intern; francizele/B2B sunt flux comercial între firme.
