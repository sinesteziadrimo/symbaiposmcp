"""Transfer a generated local photo to the capability returned by Symbai MCP. No AI API."""
import argparse
import json
import re
import sys
...
def upload(file_path, receipt_path, tenant_url):
    ...
    if not re.fullmatch(r"/objects/uploads/mcp-menu-photo-[0-9a-f-]{36}\.(png|jpeg|webp)", target.path):
