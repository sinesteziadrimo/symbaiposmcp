...
Pentru picking, colete și predare citește [depozit-colete-predare](../../knowledge/depozit-colete-predare.md); pentru GLS și puncte de ridicare, [gls-magazin-online](../../knowledge/gls-magazin-online.md). Emiterea AWB-ului și schimbarea statusului nu înlocuiesc pregătirea stocului și confirmarea preluării fizice.
