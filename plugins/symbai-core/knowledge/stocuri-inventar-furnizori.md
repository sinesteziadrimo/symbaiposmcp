...
- **Hub Aprovizionare** (`/smart-ordering`) — „Smart Order Hub", centrul comenzilor de aprovizionare, cu 4 taburi: Comenzi (pipeline), Predicție & Planificare, Furnizori, Istoric Aprovizionare. Generează comenzi ciornă, apoi „Revizuire & Trimite".
