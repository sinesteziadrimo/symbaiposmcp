...
- **Cheia OpenAI** — implicit folosești cheia gestionată de Symbai; opțional activezi cheia proprie din Setări → Integrări (cardul OpenAI): se salvează criptat, nu se afișează niciodată înapoi, iar cu cheie proprie poți personaliza nivelurile de modele (Nano/Standard/Heavy/Premium), altfel configurate central de Symbai și ascunse din pagină.
