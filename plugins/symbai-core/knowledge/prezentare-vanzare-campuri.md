...
- **Pricing Tiers** („Adaugă tier"): **Nume** · **RECOMANDAT** (unic/ofertă) · **Descriere** · **Preț** `nr` · **Perioadă** /lună//an/unic/custom · **Beneficii** (1/linie) · Styling: **Culoare accent** `culoare` · **Stil card** Minimal/Glass/Gradient/Spotlight · **Icon/emoji** · **Highlights (max 3)** · **Ribbon** (text + gradient + sparkle).
...
- **Slide 2 Wishlist „Ce ai bifa?"**: **Kicker** · **Stilul răspunsurilor** (Carduri cu icon / Listă simplă) · **Întrebarea** · **Subtitlu** · **Opțiunile** (~10; fiecare: Iconiță + Titlu scurt + Descriere + panou „💔 dureri" §4). Buton „Leagă bifele de dureri" (seed 1-click).
