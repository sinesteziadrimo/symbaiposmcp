...
- **Canal „local" (comenzi la telefon)** — un canal intern, fără platformă externă: operatorul compune manual comanda (client, telefon, adresă, produse din meniul canalului) direct din Centrul de Comenzi. Comenzile locale trec prin aceleași stări (acceptată → în pregătire → gata → predată curierului/ridicată), merg la bucătărie ca orice comandă de livrare, dar nu anunță nicio platformă.
...
- **Livrări** (`/deliveries`, „Centru Livrări") — monitorizarea live a comenzilor de pe platforme: carduri statistici (comenzi noi, active, în pregătire, gata de ridicare, venituri și comision azi, canale pauzate), tab-uri Comenzi Active / Kanban / Istoric Comenzi / Rapoarte / Platforme. Accepți sau refuzi comenzi (cu motiv), le treci prin pregătire → gata → predată curierului (statusul „Livrată" vine apoi automat de la platformă); buton „Acceptă Toate" (cere permisiunea de acțiuni în masă) și sunet de alertă la comenzi noi.
- **Centru de Comenzi** (`/deliveries/pos`) — cockpit-ul operatorului de livrări, optimizat pentru lucru rapid: carduri sau listă cu toate comenzile de pe canale, selecție multiplă cu acțiuni în masă pe fiecare stare, buton **„Comandă nouă"** (comanda manuală la telefon, pe canalul „local" sau pe orice canal — alegi întâi canalul, ca prețurile să vină din meniul lui), rezervările zilei și un registru fiscal al zilei; în statisticile cockpitului vezi și **durata medie de livrare per canal**. Ce butoane apar (rezervări, voce etc.) se configurează din Configurare Afișaj, profilul „Ecran Livrări".
- **La „Predată curierului" se emite bonul fiscal**: e ultima acțiune manuală pe comandă — se deschide un dialog de metodă de plată (Wolt/Glovo/Bolt/numerar etc., preselectat pe canalul comenzii) → Symbai creează nota de vânzare și scoate bonul fiscal la casă. Nu mai există buton „Livrată": statusul „Livrată" vine automat de la platformă când curierul predă comanda (Wolt îl trimite; la Glovo comanda rămâne la „Predată" — e normal). Excepție: la comenzile pe care platforma le progresează singură (auto-accept pornit + curierul platformei), bonul iese **automat**, pe metoda de plată a platformei, la casa fiscală setată pentru livrări — de-asta „a ieșit bonul singur", fără să apese nimeni nimic. Plățile pe platformă ies pe cod fiscal „Plată modernă" (categoria corectă legal pentru plățile online, Ordin ANAF 146/2018). Dacă bonul întârzie (casa offline pe moment), sistemul îl recuperează singur în câteva minute — nu marca din nou, verifică istoricul de bonuri.
- **Butonul „Gata" și bucătăria**: dacă canalul are ecran de bucătărie (KDS) activ, butonul „Gata" din Centru de Comenzi e blocat — comanda trece pe „Gata" automat când bucătăria termină bonul pe KDS. Fără KDS pe canal, „Gata" se apasă manual.
- **Setări de tipărire livrări** (dialogul „Setări tipărire" din Centru de Comenzi): per locație poți alege o **casă fiscală dedicată livrărilor** (bonurile de delivery nu se mai amestecă cu cele din sală) și poți activa o **notă de ambalare** tipărită separat, pentru cine împachetează comanda.
- **Produse nerecunoscute de pe platforme**: dacă o comandă vine cu un produs pe care Symbai nu-l recunoaște (nume diferit pe platformă), Centru de Comenzi deschide un dialog de mapare — alegi o singură dată produsul corespondent din meniul tău, iar aliasul e ținut minte pentru toate comenzile viitoare.
...
2. **Gestionezi comenzile de pe platforme**: `/deliveries` → tab Comenzi Active → accepți (sau „Acceptă Toate") → „În pregătire" → „Gata" → **„Predată curierului"** (ultima acțiune manuală: aici alegi metoda de plată și iese bonul fiscal); refuzi cu motiv scris (ex. ingredient indisponibil). Butonul „Livrată" nu există — statusul final vine automat de la platformă (Wolt îl trimite; la Glovo comanda rămâne la „Predată").
...
- **De ce a ieșit bonul fiscal singur, fără să apese nimeni nimic?** — Comanda a fost progresată automat de platformă (auto-accept pornit + curierul platformei a preluat-o): în acest caz bonul se emite automat, pe metoda de plată a platformei, la casa fiscală setată pentru livrări. E comportamentul normal, nu o eroare — vânzarea e înregistrată corect.
- **De ce nu găsesc butonul „Livrată"?** — Nu mai există: ultima acțiune manuală e „Predată curierului" (cu alegerea plății și bonul fiscal). „Livrată" se setează automat când platforma confirmă predarea la client (Wolt trimite confirmarea; la Glovo comanda rămâne la „Predată").
- **De ce nu pot apăsa „Gata" în Centru de Comenzi?** — Canalul are ecran de bucătărie (KDS) activ: comanda se marchează „Gata" automat din bucătărie, când bonul e terminat pe KDS. Butonul e blocat intenționat, ca statusul să reflecte realitatea din bucătărie.
...
- **Livratorii costă în plus?** Da — fiecare angajat bifat ca livrator se taxează nominal (modulul Livrator; tariful curent îl vezi în portalul Hub, la Module & Facturare) și numărul se trimite automat în Hub. Bifarea nu dă și nu ia acces la pagini.
