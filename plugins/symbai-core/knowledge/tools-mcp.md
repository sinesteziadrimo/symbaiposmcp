...
- `explain_production_day` — Explică ziua de producție unui owner, în limbaj simplu pe românește: privire de ansamblu (loturi în lucru/finalizate, calitate), ce se produce și cine lucrează pe ture, producția zilei (cantități, randament) și puncte de atenție (QC, carantină, echipamente oprite). (parametru opțional: date YYYY-MM-DD, implicit azi)
