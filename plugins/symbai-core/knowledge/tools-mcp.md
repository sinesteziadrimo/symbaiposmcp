...
- `get_factory_plan_palette` — Listează entitățile REALE disponibile pentru a fi puse pe plan (zone de producție, echipamente, magazii, zone de depozitare), marcând care sunt deja plasate. (necesită: planId)
...
- `update_factory_object` — Editează un obiect: poziție (x/y), dimensiuni, rotație, nivel, etichetă, culoare, status, HACCP (airClass/hygieneZone/allergens/temp), capacitate. (necesită: objectId)
