...
**TOTAL: 965 tool-uri** — Citire 416 · Speciale 5 · SQL 3 · Scriere per modul 541 (pe 19 module).

## Citire (fără permisiune de modul) — 416 tool-uri
...
- `list_employees` — Listează angajații activi cu nume, rol, departament, poziție, salariu orar și brand/locație primară + acces multi-brand/multi-locație. (parametri opționali: includeInactive, department)
