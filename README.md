...
- **skills/** — workflow-uri pas-cu-pas (configurarea completă a unui client nou — onboarding, găsește o pagină, investighează o masă, adaugă un produs/rețetă, programează o postare, rapoarte & prețuri, trimite ticket de suport/sugestie către echipa Symbai).
